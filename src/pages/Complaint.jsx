...
const ComplaintForm = () => {
  ...
  const onSubmitForm = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://arjun-college-project-backend.onrender.com/complaints", {
        method: "POST",
        headers: headers,
...
<div>
  <div class="mt-1">
    <textarea id="complaint-description" name="complaint-description" rows="3" class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Complaint Description" onChange={(e) => setDescription(e.target.value)}></textarea>
      ...
      <section class="bg-red-100 py-12 text-gray-800 sm:py-24 h-full">
        <div class="bg-green-100 mx-auto flex max-w-md flex-col rounded-lg lg:max-w-screen-xl lg:flex-row">
          <div class="max-w-2xl px-4 lg:pr-24">
            <p class="mb-2 text-blue-600">College Grievance Redressal</p>
            <h3 class="mb-5 text-3xl font-semibold">Submit Your Grievance</h3>
            <p class="mb-16 text-md text-gray-600">College Grievance Redressal ensures a swift and confidential resolution of students and faculty concerns. We guarantee a quick response to submitted complaints, fostering a secure and comfortable living environment for all college students and faculty.</p>
            ...
            <div class="mb-5 flex font-medium">
              ...
              <div class="">
                ...
                <span class="font-normal text-gray-600">Your grievances are handled with utmost confidentiality, ensuring privacy and trust throughout the College grievance redressal process .</span>
              </div>
            ...
            <div class="mb-5 flex font-medium">
              ...
              <div class="">
                ...
                <span class="font-normal text-gray-600">
                  Effortless communication is facilitated, providing a smooth and accessible channel for expressing and resolving grievances within the college campus.</span>
              </div>

            </div>
          </div>
          <div class="border border-gray-100 shadow-gray-500/20 mt-8 mb-8 max-w-md bg-green shadow-sm sm:rounded-lg sm:shadow-lg lg:mt-0">
            <div class="relative border-b border-gray-300 p-4 py-8 sm:px-8">
              ...
              <p class="text-gray-600">Contact us for College grievance redressal</p>

            </div>
            <div class="p-4 sm:p-8">
              <input id="name" type="text" class="mt-1 w-full resize-y overflow-auto rounded-lg border border-gray-300 px-4 py-2 shadow-sm focus:border-blue-500 focus:outline-none hover:border-blue-500" placeholder="Enter your Full Name" onChange={(e) => setName(e.target.value)} />
  ...
  const handleApproval = async (complaint_id) => {
    try {
      const response = await fetch(
        `https://arjun-college-project-backend.onrender.com/complaints/${complaint_id}`,
        {
          method: "GET",
          headers: GetAuthHeader(),
        }
